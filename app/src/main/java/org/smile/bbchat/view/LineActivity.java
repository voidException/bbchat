...
import org.smile.bbchat.bean.Meizi;
import org.smile.bbchat.bean.SnackbarUtil;
import org.smile.bbchat.net.MyOkhttp;
...
public class LineActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        new GetData().execute("http://gank.io/api/data/福利/10/1");  //本文后面的方法

        //获取屏幕宽度
        WindowManager wm = (WindowManager) LineActivity.this.getSystemService(Context.WINDOW_SERVICE);
