...
import org.smile.bbchat.MainActivity;

import java.util.regex.Pattern;

/**
 * Created by aihaitao on 17/9/2017.
 */
...
public class LinkifySpannableUtils {
    ...
    private void call(final String mobile, final Context activity) {
        ...
        if (ActivityCompat.checkSelfPermission(activity, Manifest.permission.CALL_PHONE) != PackageManager.PERMISSION_GRANTED) {
            ...
            ActivityCompat.requestPermissions((Activity) activity, new String[]{Manifest.permission.CALL_PHONE}, MainActivity.RESULT_CANCELED);
